...
namespace Inkluzitron.Modules
{
    public class ReactionsModule
    {
        ...
        private async Task DiscordClient_ReactionChanged(Cacheable<IUserMessage, ulong> userMessage, Cacheable<IMessageChannel, ulong> _, SocketReaction reaction, ReactionEvent eventType)
        {
